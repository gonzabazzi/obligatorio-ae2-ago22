...
public class ViajeCostoMinimoKilometrosTest {
    ...
    private void cargarSetCentrosUrbanosYCaminos1() {
        ...
        sistema.registrarCamino(new String("1"), new String("6"), 10, 20, 14, EstadoCamino.BUENO);
        sistema.registrarCamino(new String("2"), new String("4"), 10, 20, 15, EstadoCamino.BUENO);
        sistema.registrarCamino(new String("3"), new String("4"), 10, 20, 15, EstadoCamino.BUENO);
        sistema.registrarCamino(new String("3"), new String("6"), 10, 20, 1, EstadoCamino.BUENO);
        sistema.registrarCamino(new String("3"), new String("5"), 10, 20, 3, EstadoCamino.BUENO);
    }
    ...
    void deberiaDevolverCostoMinimo() {
        ...
        assertEquals("1;CentroUrbano1|3;CentroUrbano3|4;CentroUrbano4", retorno.getValorString());
    }

    @Test
    void deberiaDevolverCostoMinimo1(){
        cargarSetCentrosUrbanosYCaminos1();
        sistema.registrarCamino(new String("5"), new String("4"), 10, 20, 8, EstadoCamino.BUENO);
        retorno = sistema.viajeCostoMinimoKilometros(new String("1"), new String("4"));
        assertEquals(Retorno.Resultado.OK, retorno.getResultado());
    ...
    void deberiaDevolverCostoMinimo2(){
        cargarSetCentrosUrbanosYCaminos1();
        sistema.registrarCamino(new String("5"), new String("4"), 10, 20, 8, EstadoCamino.MALO);
        retorno = sistema.viajeCostoMinimoKilometros(new String("1"), new String("4"));
        assertEquals(Retorno.Resultado.OK, retorno.getResultado());
        assertEquals(17, retorno.getValorInteger());
        assertEquals("1;CentroUrbano1|3;CentroUrbano3|4;CentroUrbano4", retorno.getValorString());
